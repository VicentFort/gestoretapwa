        ...
        <v-col>
            <v-card>
                ...
                <v-list class="pa-0">
                    ...
                    <!-- Date Chip -->
                    <template #prepend>
                        <div class="flex-column justify-center mr-4 align-center date-chip d-flex">
                        <span class="text-caption font-weight-bold text-grey-darken-1">
                            {{ monthLabel(event.date) }}
                        </span>
                        <span class="font-weight-bold text-tertiary" style="font-family: 'Instrument Serif', serif; font-size: 1.125rem;">
                            {{ dayLabel(event.date) }}
                        </span>
                        </div>
                    </template>
